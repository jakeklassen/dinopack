  ...
  */
  ...
  export type IpAggregateArgs = {
    ...
    **/
     ...
     * 
    **/
    orderBy?: Enumerable<IpOrderByWithRelationInput>
    /**
  ...
  export type IpGroupByArgs = {
    where?: IpWhereInput
    orderBy?: Enumerable<IpOrderByWithAggregationInput>
  ...
  type GetIpGroupByPayload<T extends IpGroupByArgs> = PrismaPromise<
    Array<
  ...
  export interface IpDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Ip'> extends True ? CheckSelect<T, Prisma__IpClient<Ip>, Prisma__IpClient<IpGetPayload<T>>> : CheckSelect<T, Prisma__IpClient<Ip | null, null>, Prisma__IpClient<IpGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Ip'> extends True ? CheckSelect<T, Prisma__IpClient<Ip>, Prisma__IpClient<IpGetPayload<T>>> : CheckSelect<T, Prisma__IpClient<Ip | null, null>, Prisma__IpClient<IpGetPayload<T> | null, null>>
    ...
    **/
    ...
    /**
     * Find one Ip that matches the filter or throw
     ...
     * })
    **/
    findUniqueOrThrow<T extends IpFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, IpFindUniqueOrThrowArgs>
    ): CheckSelect<T, Prisma__IpClient<Ip>, Prisma__IpClient<IpGetPayload<T>>>
     ...
     * })
    **/
    findFirstOrThrow<T extends IpFindFirstOrThrowArgs>(
      args?: SelectSubset<T, IpFindFirstOrThrowArgs>
    ): CheckSelect<T, Prisma__IpClient<Ip>, Prisma__IpClient<IpGetPayload<T>>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, IpGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetIpGroupByPayload<T> : PrismaPromise<InputErrors>
   ...
   */
  export class Prisma__IpClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
  ...
  /**
   * Ip base type for findUnique actions
   */
  export type IpFindUniqueArgsBase = {
    /**
   ...
   * Ip: findUnique
   */
  export interface IpFindUniqueArgs extends IpFindUniqueArgsBase {
   /**
  ...
  /**
   * Ip base type for findFirst actions
   */
  export type IpFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Ip
     * 
    **/
   ...
   * Ip: findFirst
   */
  export interface IpFindFirstArgs extends IpFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
   ...
   */
  export type IpFindUniqueOrThrowArgs = IpFindUniqueArgsBase
      

  /**
   * Ip: findFirstOrThrow
   */
  export type IpFindFirstOrThrowArgs = IpFindFirstArgsBase
  ...
  export type IpScalarWhereWithAggregatesInput = {
    ...
    requests?: IntWithAggregatesFilter | number
